//! AES-OCB3 (RFC 7253) functional tests
//!
//! OCB3 is a single-pass, parallelizable authenticated encryption mode.
//! No Wycheproof vectors exist for OCB, so these are comprehensive functional tests.
