//! Precomputed Constants for NEON ML-DSA Implementation
//!
//! This module contains all precomputed constants used throughout the NEON
...
//! # Memory Layout
//!
//! All arrays are aligned for efficient NEON loads (16-byte aligned).
...
/// Number of NEON vectors per polynomial (256 / 4 = 64)
pub const VECS_PER_POLY: usize = N / 4;
...
#[inline]
#[target_feature(enable = "neon")]
pub unsafe fn qinv_vec() -> int32x4_t {
    vdupq_n_s32(QINV)
}
...
#[inline]
#[target_feature(enable = "neon")]
pub unsafe fn f_shoup_vec() -> int32x4_t {
    vdupq_n_s32(F_SHOUP)
}
...
#[inline]
#[target_feature(enable = "neon")]
pub unsafe fn zero_vec() -> int32x4_t {
    vdupq_n_s32(0)
}
...
#[inline]
#[target_feature(enable = "neon")]
pub unsafe fn one_vec() -> int32x4_t {
    vdupq_n_s32(1)
}
