//! SHA-512/256 (Secure Hash Algorithm 512/256)
//!
//! SHA-512/256 is a variant of SHA-512 with different initial values
//! and truncated output to 256 bits (32 bytes).
//!
//! Specified in FIPS 180-4.

use hpcrypt_core::utils::{read_u64_be, rotr64, write_u64_be};

/// SHA-512/256 block size in bytes (same as SHA-512: 1024 bits = 128 bytes)
pub const BLOCK_LEN: usize = 128;

/// SHA-512/256 output size in bytes (256 bits = 32 bytes)
...
impl crate::traits::HashFunction for Sha512_256 {
    ...
    fn new() -> Self {
        Self {
            // SHA-512/256 initial values (specified in FIPS 180-4)
            h: [
                0x22312194fc2bf72c,
                0x9f555fa3c84c64c2,
                0x2393b86b6f53b151,
    ...
    fn finalize(mut self) -> Self::Output {
        ...
        // Output first 32 bytes (4 words) of state
...
pub fn sha512_256(data: &[u8]) -> [u8; OUTPUT_LEN] {
    use crate::traits::HashFunction;
    Sha512_256::hash(data)
}
