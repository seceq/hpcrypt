...
/// ```
pub fn split_secret(secret: &[u8], threshold: usize, num_shares: usize) -> Result<Vec<Share>, CurveError> {
    // Validate parameters
    if threshold < 2 {
    ...
    for &secret_byte in secret.iter() {
        ...
        for _ in 1..threshold {
            ...
            generate_random_bytes(&mut rand_byte)
                .map_err(|_| CurveError::InvalidEncoding {
