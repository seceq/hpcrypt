...
fn main() {
    ...
    println!("   Alice's private key: {:02x}{:02x}{:02x}{:02x}...{:02x}{:02x}{:02x}{:02x}",
             alice_private[0], alice_private[1], alice_private[2], alice_private[3],
             alice_private[28], alice_private[29], alice_private[30], alice_private[31]);
    println!("   Alice's public key:  {:02x}{:02x}{:02x}{:02x}...{:02x}{:02x}{:02x}{:02x}",
             alice_public[0], alice_public[1], alice_public[2], alice_public[3],
             alice_public[28], alice_public[29], alice_public[30], alice_public[31]);
    ...
    println!("   Bob's private key:   {:02x}{:02x}{:02x}{:02x}...{:02x}{:02x}{:02x}{:02x}",
             bob_private[0], bob_private[1], bob_private[2], bob_private[3],
             bob_private[28], bob_private[29], bob_private[30], bob_private[31]);
    println!("   Bob's public key:    {:02x}{:02x}{:02x}{:02x}...{:02x}{:02x}{:02x}{:02x}",
             bob_public[0], bob_public[1], bob_public[2], bob_public[3],
             bob_public[28], bob_public[29], bob_public[30], bob_public[31]);
    ...
    println!("   Alice's shared:      {:02x}{:02x}{:02x}{:02x}...{:02x}{:02x}{:02x}{:02x}",
             alice_shared[0], alice_shared[1], alice_shared[2], alice_shared[3],
             alice_shared[28], alice_shared[29], alice_shared[30], alice_shared[31]);
    println!("   Bob's shared:        {:02x}{:02x}{:02x}{:02x}...{:02x}{:02x}{:02x}{:02x}",
             bob_shared[0], bob_shared[1], bob_shared[2], bob_shared[3],
             bob_shared[28], bob_shared[29], bob_shared[30], bob_shared[31]);
    ...
    println!("   Carol's public key: {:02x}{:02x}{:02x}{:02x}...{:02x}{:02x}{:02x}{:02x}",
             carol_public[0], carol_public[1], carol_public[2], carol_public[3],
             carol_public[28], carol_public[29], carol_public[30], carol_public[31]);
    ...
    println!("   Alice-Carol shared: {:02x}{:02x}{:02x}{:02x}...",
             alice_carol_shared[0], alice_carol_shared[1],
             alice_carol_shared[2], alice_carol_shared[3]);
    println!("   Bob-Carol shared:   {:02x}{:02x}{:02x}{:02x}...",
             bob_carol_shared[0], bob_carol_shared[1],
             bob_carol_shared[2], bob_carol_shared[3]);
    println!("   Carol-Alice shared: {:02x}{:02x}{:02x}{:02x}...",
             carol_alice_shared[0], carol_alice_shared[1],
             carol_alice_shared[2], carol_alice_shared[3]);

    println!("   Alice-Carol = Carol-Alice: {}",
             if alice_carol_shared == carol_alice_shared { "✓ Yes" } else { "✗ No" });
    println!("   Alice-Carol ≠ Bob-Carol:   {}",
             if alice_carol_shared != bob_carol_shared { "✓ Correct" } else { "✗ Wrong" });
    println!();
    ...
    println!("   Computed:    {:02x}{:02x}{:02x}{:02x}...{:02x}{:02x}{:02x}{:02x}",
             rfc_shared[0], rfc_shared[1], rfc_shared[2], rfc_shared[3],
             rfc_shared[28], rfc_shared[29], rfc_shared[30], rfc_shared[31]);
    println!("   Expected:    {:02x}{:02x}{:02x}{:02x}...{:02x}{:02x}{:02x}{:02x}",
             rfc_expected_shared[0], rfc_expected_shared[1],
             rfc_expected_shared[2], rfc_expected_shared[3],
             rfc_expected_shared[28], rfc_expected_shared[29],
             rfc_expected_shared[30], rfc_expected_shared[31]);
    println!("   RFC Compliant: {}",
             if rfc_shared == rfc_expected_shared { "✓ Yes" } else { "✗ No" });
    println!();
