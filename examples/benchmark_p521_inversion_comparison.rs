...
fn main() {
    ...
    println!("  Time per inversion: {:.2} μs ({:.0} ns)", us_per_inv_gcd, ns_per_inv_gcd);
    println!("  Throughput: {:.0} inversions/sec", 1_000_000.0 / us_per_inv_gcd);
    ...
    println!("  Total inversions: {}", total_inversions);
    println!("  Time per inversion: {:.2} μs ({:.0} ns)", us_per_inv_fermat, ns_per_inv_fermat);
    println!("  Throughput: {:.0} inversions/sec", 1_000_000.0 / us_per_inv_fermat);
    ...
    println!();
    println!("  Time saved per inversion: {:.2} μs", us_per_inv_fermat - us_per_inv_gcd);
    println!("  Time saved per 1000 inversions: {:.2} ms", (us_per_inv_fermat - us_per_inv_gcd) / 1000.0);
