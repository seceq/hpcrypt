...
fn bench_scalar_multiplication(c: &mut Criterion) {
    ...
    let scalar = [
        ...
        0xF0, 0xFE, 0xDC, 0xBA, 0x98, 0x76, 0x54, 0x32, 0x10, 0x01, 0x23, 0x45, 0x67, 0x89, 0xAB,
        0xCD, 0xEF,
    ];
...
fn bench_generator_multiplication(c: &mut Criterion) {
    use hpcrypt_curves::p256::precomputed::{
        scalar_mul_generator, scalar_mul_generator_balanced, scalar_mul_generator_compressed,
        scalar_mul_generator_wide,
    };
